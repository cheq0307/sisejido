...
<head>
    <meta charset="UTF-8">
    <title>Ejido San Rafael Ixtapalucan - Nuevo Artículo</title>
...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 text-ejidal">Nueva Entrada</h1>
...
<div class="card-header card-header-ejidal">Registrar Entrada</div>
<div class="card-body">
    ...
    <div class="col-md-6">
        ...
        <select name="id_equipo" class="form-select" required>
            ...
            @foreach($articulos as $a)
                <option value="{{ $a->id_equipo }}">{{ $a->descripcion }}</option>
            @endforeach
        </select>
    </div>
